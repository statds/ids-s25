...
This section was prepared by Shiyi Li. (Add more to introduce yourself)
...
- This will create a structural context for you, like this:   (找到可以只显示结果的方法，但不影响整个introduction section 的structure。)
...
3. [GitHub Flavored Markdown (GFM)] [@macfarlane2019github]: Markdown features specific to GitHub. 
4. [Jupyter Notebook Markdown] [@macfarlane2025pandoc]: Use Markdown for interactive data science.
