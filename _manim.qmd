...
### [3blue1Brown](https://www.3blue1brown.com) <img src="images\3b1b_logo.png" alt="logo" width="20"/> 
...
### Manim Workflow
Each animation that is made using manim can be boiled down to the following
five simple steps. 
...
interact with the scene options presented above 
like `Scene` or `ThreeDScene` will be the same. There are just different 
...
position of the camera, and the orientation of objects in 3D space. 
...
at the center of the screen (the origin). If you want to place a circle 
(any object) 
to the left or right of the page, you can write `circle.move_to(LEFT)`. Similarly,
...
font size, color, position. You can also link its position relative to another
object.

Finally you will use the command line or terminal of your choice to render your
animation. I must admit that there is a lot of upfront effort required to 
...
and ChatGPT. Still, it took me many hours to get all of the dependencies and 
packages to be installed correctly. If you already have a latex rendering 
package and video rendering package installed and added to your PATH, then it
...
These here are the commands that animate. This is where you can be 
creative!
...
#| eval: false
        ...
        self.play(Transform(prUnion, prFormula),
                  intersection.animate.set_fill(color=BLACK, opacity=1),
...
### Learnings
  ...
  - Takes time upfront, but allows you to convey concepts quickly
  - You can impress sponsors or boss
  - It is cool. I made this for the lab I work in using just an image (.svg)
...
### Further readings 
You should be able to find everything you need from the documentation and there
is no better gallery than 3Blue1Brown's free online videos. He also posts all
