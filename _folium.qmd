...
folium.GeoJson('data/canada_provinces.geojson', name="Canada").add_to(m)
...
folium.GeoJson('data/canada_provinces.geojson', name="Canada",
               style_function= lambda x: style).add_to(m)
...
folium.GeoJson("data/new-york-city-boroughs.geojson", name='Borough borders',
style_function=lambda x: style).add_to(m)
