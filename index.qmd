...
+ Tamhane, Shubhan
    - Learn various machine learning algorithims such as logistic regression and random forest
    - Learn about the intersection of SQL, git, and python when solving a real data science problem
