...
+ Tamhane, Shubhan
    - Learn about the intersection between git, SQL, and Python in the context of solving a data science problem
    - Learn different machine learning algorithims such as logistic regression, random forest, clustering, etc. 
