...
+ Roy, Luke
    - Have fun
    - Develop skills in fianncial data analyis using python and relevant libraries like numpy and pandas.
    - Learn advanced data visualization skills with a focus on the Grammar of Graphics.
