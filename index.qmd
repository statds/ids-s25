...
+ Kline, Daniel Esteban
    - Become more adept at using git repositories
    - Learn more about the data science process
    - Get comfortable with the process so that I could streamline my work
+ Lagutin, Vladislav
...
Please use the following table to sign up.
  ...
  ----- | ------------- | -------------------------
   ...
   03/10 |  Kline, Daniel Esteban     | Import/Export data
