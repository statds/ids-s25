...
+ A good resource for sports analytics if [ScoreNetwork](https://scorenetwork.org).
...
+ Kline, Daniel Esteban
    - Practice more in github to overcome strugglew with using it
    - Learn more about the data science process and what it means to be a data scientist
    - Get comfortable with the work so assignments will be easier in the fututre
+ Lagutin, Vladislav
...
Please use the following table to sign up.
  ...
  ----- | ------------- | -------------------------
   ...
   03/10 |  Kline, Daniel Esteban     | Web Scraping
