...
+ Shiyi, Li 
    - Learn to visualize the plots and results using ggplot package.
    - Learn to apply the common functions in the SciPy, scikit-learn, and statsmodels libraries in Python
    - Learn to query, extract, and adjust structured and unstructured data in a big database.
    - Learn basics of artificial neural networks, CNNs for image data, NLP techniques.
