...
+ Kline, Daniel Esteban
    - Become better at guiding myself through git hub and its repositories
    - Learn more about the data science process and what it means
    - Get comfortable with the workflow so assignments can be done more efficently
+ Lagutin, Vladislav
