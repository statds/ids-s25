...
This section was prepared by Gaofei Zhang. I am a second year PhD student in Health Promotion Science. 
...
In our example, we predict the number of persons injured in NYC crashes by using accident attributes.
...
- The results show that LATITUDE, LONGITUDE, and CRASH HOUR significantly impact the model predictions, 
suggesting these attributes play a major role in predicting the number of persons injured.

- Although the R² scores in both cross-validation and testing are negative, 
this reflects the current limitations of the model and indicates potential areas for improvement in feature engineering and model tuning.
...
- In this example, accident attributes were used to predict "NUMBER OF PERSONS INJURED", 
demonstrating a practical application of Random Forest in regression tasks.
