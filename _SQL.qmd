...
* My name is Alyssa Horn. I am a junior Applied Data Analysis major
with a domain in Public Policy/Management. I plan on graduating in
December of 2025.

* This presentation explores database operations using SQL in Python,
...
# Load CSV
data = pd.read_csv('07_04_2024weekNYCcrash_filtered.csv')
...
VALUES ('06/30/2024', '10:15', 'BROOKLYN',
'Driver Inattention/Distraction')
""")
...
WHERE crash_date = '06/30/2024' 
AND crash_time = '10:15' 
