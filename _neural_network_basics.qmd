...
![Figure 3: A long short-term memory network diagram](images/neural_network_basics_visuals/lstm_example.png){fig-align="center" .fragment}
...
```{python}
#| echo: false
#| fig-cap: "Figure 5: Graphs of the sigmoid and hyperbolic tangent functions"
import numpy as np
...
```{python}
#| echo: false
#| fig-cap: "Figure 6: Graphs of the ReLU and Leaky ReLU functions"
