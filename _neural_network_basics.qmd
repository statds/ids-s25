...
![Figure 1: A demonstration of the bioligical inspiration for the perceptron (“The Design of an Intelligent Automaton”, Summer 1958)](images/neural_network_basics_visuals/perceptron1.png){fig-align="center" .fragment}
...
![Figure 2: The computational framework for the perceptron, as originally developed (“The Design of an Intelligent Automaton”, Summer 1958)](images/neural_network_basics_visuals/perceptron2.jpg){fig-align="center" .fragment}
...
1995, whose architecture (as shown in Figure 3) revolutionized neural networks
and became required reference material for further development in this field.

![Figure 3: A long short-term memory network diagram, credit to [GeeksForGeeks](https://www.geeksforgeeks.org/deep-learning-introduction-to-long-short-term-memory/)](images/neural_network_basics_visuals/lstm.jpg){fig-align="center" .fragment}
...
Figure 4. These mathematically modify the information in each layer to show what
is important to be passed on, usually by multiplying the weight by all of the
activations of the nodes it is connected to.

![Figure 4: A neural network skeleton](images/neural_network_basics_visuals/neural-network.png){fig-align="center" .fragment}
...
![Figure 5: Graphs of the sigmoid and hyperbolic tangent functions](images/neural_network_basics_visuals/activation_funcs_1.png){fig-align="center" .fragment}
...
and Leaky ReLU, shown in Figure 6. 
...
![Figure 6: Graphs of the ReLU and Leaky ReLU functions](images/neural_network_basics_visuals/activation_funcs_2.png){fig-align="center" .fragment}
...
![Figure 7: Example of calculated activations](images/neural_network_basics_visuals/sample_network.png){fig-align="center" .fragment}
...
![Figure 8: A handwritten 3 from the MNIST dataset](images/neural_network_basics_visuals/Example-of-a-MNIST-input-An-image-is-passed-to-the-network-as-a-matrix-of-28-by-28.png){fig-align="center" .fragment}
...
accuracy on the MNIST dataset is quite high, showing that a model like this can
indeed work to learn information from images to generate predictions.
