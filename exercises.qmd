...
1. **Midterm project: Street flood in NYC** 
   ...
   your report while going through the questions.
    ...
    a.  Exploratory analysis.
        ...
        i.  Is there significant difference in response time between SF
           and CB complaints? Visualize the comparison. State your
   hypothesis, justify your test, and summarize your results in plain
   English.
        i.  Is there significant difference in response time across
   different boroughs? Visualize the comparison. State your
   hypothesis, justify your test, and summarize your results.
        i.  Does the difference in response time across boroughs
   depend on the complaint descriptor? Visualize the comparison (the original
   scale may not be the best given the outliers in the data). State your
   hypotheses, justify your test, and summarize your results.
   ...
   area and the ACS 2023 variables  (`data/nyc_zip_areas.feather` and
